...
public class BookSelectPublisher extends AppCompatActivity {
    private EditText publisher;
    public static final String attr="publisher";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.book_select_publisher);
        publisher = (EditText) findViewById(R.id.editText);
    }
    public void select(View v) {

        ListView lv = (ListView) findViewById(R.id.lv);
        BookControl bookcontrol = new BookControl(BookSelectPublisher.this);
        String book_attr = publisher.getText().toString().trim();//输入的字段
