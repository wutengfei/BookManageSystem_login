...
public class BookSelectPubday extends AppCompatActivity {
    private EditText pubday;
    public static final String attr="pubday";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.book_select_pubday);
        pubday = (EditText) findViewById(R.id.editText);
    }

    public void select(View v) {
        ListView lv = (ListView) findViewById(R.id.lv);
        BookControl bookcontrol = new BookControl(BookSelectPubday.this);
        String  book_attr= pubday.getText().toString().trim();//输入的字段
