...
public class BookSelectAuthor extends AppCompatActivity {
    private EditText author;
    public static final String attr="author";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.book_select_author);
        author = (EditText) findViewById(R.id.editText);
    }

    public void select(View v) {

        ListView lv = (ListView) findViewById(R.id.lv);
        BookControl bookcontrol = new BookControl(BookSelectAuthor.this);
        String book_attr = author.getText().toString().trim();//输入的字段
